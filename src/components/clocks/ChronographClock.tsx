  ...
  return (
    <div className={cn(
        ...
        return (
          ...
          >
            <div className={cn(
              ...
              visualStyle === 'retro' && "bg-[var(--app-foreground)] opacity-85",
      ...
      <div className={cn(
        ...
        "border-divider bg-content1 shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)]",
        visualStyle === 'retro' && "border-2 border-[var(--app-foreground)] bg-content1 shadow-none rounded-none",
        visualStyle === 'glass' && "border border-[var(--glass-border)] bg-white/5 backdrop-blur-sm",
        visualStyle === 'soft' && "border-none bg-content1 shadow-[var(--soft-shadow-dark)]"
      )}>
        <svg className="absolute inset-0 w-full h-full -rotate-90">
          <circle cx="50%" cy="50%" r="43%" fill="none" stroke="currentColor" className="text-[var(--app-outline)]/20" strokeWidth="1.5" />
          <circle cx="50%" cy="50%" r="43%" fill="none" stroke="currentColor" className="text-primary" strokeWidth="2" strokeDasharray={`${(prayerProgress / 100) * 270} 270`} strokeLinecap="round" />
        </svg>
        <span className={cn(
      ...
      <div className={cn(
        ...
        <span className="absolute top-0.5 text-[8px] sm:text-[9px] font-black text-[var(--app-outline)]/70 select-none">24</span>
        <span className="absolute bottom-0.5 text-[8px] sm:text-[9px] font-black text-[var(--app-outline)]/70 select-none">12</span>
      ...
      <div className={cn(
        ...
        visualStyle === 'retro' && "bg-content1 text-foreground border-2 border-[var(--app-foreground)] rounded-none shadow-none",
        visualStyle === 'glass' && "bg-[var(--glass-bg)] border border-[var(--glass-border)] text-foreground",
        visualStyle === 'soft' && "bg-content1 text-primary shadow-[var(--soft-shadow-dark)]"
      )}>
