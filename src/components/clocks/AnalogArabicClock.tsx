...
export function AnalogArabicClock({ movement }: { movement: 'tick' | 'sweep' }) {
  ...
  return (
    <div className={cn(
      ...
      {ARABIC_POSITIONS.map((pos, idx) => (
        <div
          ...
          className={cn(
            ...
            "text-foreground drop-shadow-[0_2px_2px_rgba(0,0,0,0.18)]",
      ...
      <div className="absolute top-1/2 left-1/2 w-2.5 h-2.5 -ml-1.25 -mt-1.25 bg-[var(--app-danger)] rounded-full z-30 pointer-events-none"></div>
